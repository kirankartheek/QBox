...
# cpuSpeedInMHz=cat /proc/cpuinfo | grep '^ cpuMHz' | awk '{print $4"/30+";}'
# grep 'model name' /proc/cpuinfo | head -1 | awk -F: '{print $6/1024}'
cpuSpeedInMHz=$(grep "cpu MHz" /proc/cpuinfo | awk '{print $4}' | awk 'FNR==1')
