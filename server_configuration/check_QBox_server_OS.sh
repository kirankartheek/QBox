...
linuxType=$(grep "NAME" /etc/os-release | awk 'NR==1')
linuxType=${linuxType:6:6}
...
ubuntuVersion=$(grep "VERSION_ID" /etc/os-release | awk 'NR==1')
ubuntuVersion=${ubuntuVersion:12:2}
